...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CgqKofUy.mjs");
...
var manifest = {
	"222c224a39e1886e9917b5cc1b07475326f45acc594b02846a472db067fb3f9b": {
		functionName: "sendPasswordReset_createServerFn_handler",
		importer: () => import("./auth-reset-B9rsjYzi.mjs")
	},
	"662fec499574d55d1b8072d3d530e0434af959dddb0a36e24b5a767e08b24cb1": {
		functionName: "changePassword_createServerFn_handler",
		importer: () => import("./auth-change-password-Df8ckcpi.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DS2KYuON.mjs").then((n) => n.t),
...
//#endregion
export { ssr_exports as a, getServerFnById as i, __exportAll as n, createServerFn as r, TSS_SERVER_FUNCTION as t };
