...
var grokOgIdentity = { "site": {
	"title": "GIONG VN",
	"description": "Hệ thống điều hành chuỗi trung tâm tiêm chủng Gióng Việt Nam",
	"color": "12211c",
	"card": "custom",
	"image": "/og.jpg"
} };
...
var _lazy_pdBYVm = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_pdBYVm
	};
	return ((_m, p) => {
		return {
			data,
