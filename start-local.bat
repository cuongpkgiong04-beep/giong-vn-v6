# =====================================================================
# GIONG VN — CHẠY LOCAL ĐỂ TEST (bấm đúp để chạy)
# App tổng : http://localhost:3000  (GIONG VIETNAM — điều hành chuỗi)
# App con  : http://localhost:3100  (GIONG BÁN HÀNG — SMED/MISA)
#
# Cửa sổ đen của 2 app sẽ mở ra — ĐỪNG ĐÓNG, chỉ MINIMIZE.
# Muốn DỪNG: đóng 2 cửa sổ (hoặc bấm Ctrl+C trong từng cửa sổ).
#
# LƯU Ý: máy phải có internet (app đọc dữ liệu SQL Server công ty qua
# Cloudflare Tunnel). Nếu app báo lỗi dữ liệu → tunnel có thể đã đổi
# URL: chạy lại file update-tunnel-local.bat rồi mở lại app.
# =====================================================================
@echo off
chcp 65001 >nul
